  ...
  getPosts: async (options: {
    ...
    return result.rows.map(row => {
      ...
      return {
        ...
        isVip: Boolean(isVip),
        emailVerified: row.email_verified === true || row.email_verified === 'true' || row.email_verified === 1,
        phoneVerified: row.phone_verified === true || row.phone_verified === 'true' || row.phone_verified === 1,
